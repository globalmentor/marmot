...
public class Access extends URFListResource<AccessRule> {
	...
	/**
	 * Returns an access level type that represents a summary of the access. If there is no access rule, an access level type of {@link AccessLevelType#INHERITED}
	 * will be returned. If there is a single access rule with a universal selector and an access level, its access level type will be returned. Otherwise,
	 * {@link AccessLevelType#CUSTOM} will be returned.

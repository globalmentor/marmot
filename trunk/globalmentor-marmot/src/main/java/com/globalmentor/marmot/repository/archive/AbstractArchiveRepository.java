...
public abstract class AbstractArchiveRepository<A> extends AbstractReadOnlyRepository {
	...
	/**
	 * Returns the repository containing the resource that is the source of this repository's information. If there is no source repository, the root repository
	 * will be used.
	 * @return The repository containing the resource that is the source of this repository's information, or <code>null</code> if the root repository should be
	 *         used.
	 */
	 ...
	 * @param sourceRepository The repository containing the source resource, or <code>null</code> if the root repository should be used.
	...
	/**
	 * Determines the source repository for accessing the source archive. If there is no source repository specified, the root repository is returned.

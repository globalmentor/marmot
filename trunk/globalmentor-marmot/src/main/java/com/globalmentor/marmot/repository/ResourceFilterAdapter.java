...
/**
 * A filter adapter which allows all resources. Child implementations should override {@link #isPass(URI)} or {@link #isPass(URFResource)} to provide some
 * filtering.
...
public class ResourceFilterAdapter implements ResourceFilter {
	...
	/**
	 * Determines whether a given resource should pass through the filter or be filtered out based upon its URI. This version unconditionally returns
	 * <code>true</code>.
	...
	/**
	 * Determines whether a given resource should pass through the filter or be filtered out. This version unconditionally returns <code>true</code>.

...
public class AbstractXHTMLResourceKit extends AbstractResourceKit {
	 ...
	 * @throws NullPointerException if the supported content types array and/or the supported resource types array is <code>null</code>.
	 */
	public AbstractXHTMLResourceKit(final ContentType[] supportedContentTypes, final URI[] supportedResourceTypes, final String defaultNameExtension,
	...
	/**
	 * Retrieves an excerpt from the given element. The elements are not removed from the original document. This implementation uses the first non-empty
	 * paragraph encountered depth-first.
	 * @param element The element for which an excerpt should be returned.
	 * @return A document fragment containing an excerpt of the given element, or <code>null</code> if no excerpt could be located.
	 * @see XHTML#ELEMENT_P
